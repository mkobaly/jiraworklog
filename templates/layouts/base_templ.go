...
func Navigation() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "<nav class=\"bg-blue-600 text-white shadow-lg\"><div class=\"container mx-auto px-4\"><div class=\"flex items-center justify-between h-16\"><div class=\"flex items-center\"><a href=\"/\" class=\"text-xl font-bold\">Jira Worklog</a></div><!-- Mobile menu button --><button id=\"mobile-menu-button\" class=\"md:hidden p-2 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-white\" onclick=\"document.getElementById('mobile-menu').classList.toggle('hidden')\"><svg class=\"h-6 w-6\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M4 6h16M4 12h16M4 18h16\"></path></svg></button><!-- Desktop menu --><div class=\"hidden md:flex space-x-4\"><a href=\"/\" class=\"px-3 py-2 rounded-md hover:bg-blue-700 transition\">Dashboard</a> <a href=\"/worklogs\" class=\"px-3 py-2 rounded-md hover:bg-blue-700 transition\">Worklogs</a> <a href=\"/issues\" class=\"px-3 py-2 rounded-md hover:bg-blue-700 transition\">Issues</a> <a href=\"/reports/maintenance\" class=\"px-3 py-2 rounded-md hover:bg-blue-700 transition\">Maintenance</a> <a href=\"/settings/people\" class=\"px-3 py-2 rounded-md hover:bg-blue-700 transition\">People</a></div></div><!-- Mobile menu --><div id=\"mobile-menu\" class=\"hidden md:hidden pb-4\"><div class=\"flex flex-col space-y-2\"><a href=\"/\" class=\"px-3 py-2 rounded-md hover:bg-blue-700 transition\">Dashboard</a> <a href=\"/worklogs\" class=\"px-3 py-2 rounded-md hover:bg-blue-700 transition\">Worklogs</a> <a href=\"/issues\" class=\"px-3 py-2 rounded-md hover:bg-blue-700 transition\">Issues</a> <a href=\"/reports/maintenance\" class=\"px-3 py-2 rounded-md hover:bg-blue-700 transition\">Maintenance</a> <a href=\"/settings/people\" class=\"px-3 py-2 rounded-md hover:bg-blue-700 transition\">People</a></div></div></div></nav>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
